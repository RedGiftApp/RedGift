...
struct GifList: Codable, Equatable {
    ...
    static let sample = GifList(
        ...
        gifs: [Gif(
            ...
            hls: true,
            likes: .random(in: 0..<Int(1e10)),
            hasAudio: true,
            createDate: 1731807499,
        ...
        users: [User(
            ...
            views: .random(in: 0..<Int(1e10)),
            likes: .random(in: 0..<Int(1e10)),
            followers: .random(in: 0..<Int(1e10)),
            profileImageUrl: "https://ipfs.crossbell.io/ipfs/QmUxFy91UmZ4gDcueihRoGvTZcnnzG6UuQPXADcpLBm6Po",
