...
struct UserInfoView: View {
    ...
    var body: some View {
        ZStack(alignment: .topLeading) {
            ...
            ZStack {
                LinearGradient(
                    gradient: Gradient(colors: [Color("#8F2CF2"), Color("#CD4CFF")]),
                    startPoint: .top,
                    endPoint: .bottom
                )

                Image(isFollowed ? "UserInfo/Followed" : "UserInfo/Unfollowed")
                    .resizable()
        ...
        .background {
            LinearGradient(
                gradient: Gradient(stops: [
                    ...
                    .init(color: .black.opacity(0.3), location: 0.77),
...
struct UserInfoView_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {
            Color.red
            UserInfoView(
                profile: GifList.sample.gifs[0].urls.thumbnail,
                isFollowed: false,
                toggleFollowed: {},
